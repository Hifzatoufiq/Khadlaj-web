...
new_code = """      <div style={{background:"#fff",borderTop:"1px solid #E8E4DC",padding:"30px 5%",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:20,fontSize:9,color:"#888",letterSpacing:1.5,fontFamily:"'Montserrat',sans-serif",textTransform:"uppercase"}}>
        <div>
...
if old_code in content:
    ...
    print("Successfully removed the purple background, integrated social icons to copyright bar!")
else:
