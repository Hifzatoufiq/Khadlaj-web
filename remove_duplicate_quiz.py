...
# Find the exact duplicate quiz section and delete it.
# The duplicate starts with:
#       {/* ── TESTIMONIALS ── */}
# 
# 
#       {/* ── SCENT FINDER QUIZ ── */}
# and goes all the way until the next {/* ── TESTIMONIALS ── */}

duplicate_block = """      {/* ── TESTIMONIALS ── */}
...
# We replace the duplicate block with just a single comment:
#       {/* ── TESTIMONIALS ── */}
replacement = """      {/* ── TESTIMONIALS ── */}"""

if duplicate_block in content:
    content = content.replace(duplicate_block, replacement)
    print("Successfully deleted the duplicate Scent Finder section!")
else:
    print("Could not find the target duplicate block.")
