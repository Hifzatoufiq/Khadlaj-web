...
# Find the Right Image Column (with the hotspots we added earlier) and replace it with the 2x2 Ingredient Mosaic
...
new_right_column = """          {/* Right Column: 2x2 Ingredient Mosaic */}
          <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gridTemplateRows:"1fr 1fr", gap:12, padding:"30px", background:"#050505", minHeight:"450px"}}>
            {[
              { title: "Pure Oud", img: "https://images.unsplash.com/photo-1588854337236-6889d631faa8?q=80&w=500&auto=format&fit=crop", desc: "The deep, smoky and animalic soul of luxury Arabic blends." },
              ...
              { title: "Warm Amber", img: "https://images.unsplash.com/photo-1505236271233-2f5d9d372b64?q=80&w=500&auto=format&fit=crop", desc: "Rich, golden, and resinous sweetness that locks in the fragrance." },
