...
const PRODUCTS = [
  ...
  { id:14, name:"Cream Velvet",         col:"EAU DE PARFUM",    price:130, size:"100ml Extrait",      badge:"Best Seller", gender:"Unisex", notes:["Cream","Velvet","Musk"],        img:"https://cdn.shopify.com/s/files/1/0626/6119/8023/files/Cream_Velvet_03.jpg?v=1736149481" },
  ...
  { id:208, name:"Panache",             col:"EAU DE PARFUM",    price:200, size:"100ml Extrait", badge:"Best Seller", gender:"Her",    notes:["Vanilla","Sandalwood","Musk"],  img:"https://cdn.shopify.com/s/files/1/0626/6119/8023/files/Panache_1_jpg_c97c705a-aebf-4bf9-a621-f11b565e765d.jpg?v=1771333282" },
      ...
      <section style={{padding:"0 5% 104px",background:"#fff"}}>
        <div style={{paddingTop:96,marginBottom:52,display:"flex",alignItems:"flex-end",justifyContent:"space-between",flexWrap:"wrap",gap:16}}>
          <div style={{textAlign:"left"}}>
            ...
            >
            <h2 style={{fontFamily:"'Montserrat',sans-serif",fontSize:"clamp(32px,4vw,54px)",fontWeight:300,color:"#000",lineHeight:1.15,letterSpacing:"1px"}}>
          ...
          <div>
            ...
            <div style={{display:"flex", alignItems:"center", gap:14}}>
              ...
              <span style={{display:"inline-flex", flexDirection:"column", gap:2, lineHeight:1, letterSpacing:3.4, fontFamily:"'Cinzel', 'Cormorant Garamond', serif", textTransform:"uppercase", color:"#C9A24A"}}>
                <span style={{fontFamily:"'Montserrat',sans-serif",fontSize:12, fontWeight:300, letterSpacing:"1px", color:"#C9A24A"}}>Respect the Quality Provide the Best</span>
              </span>
            </div>
          </div>
