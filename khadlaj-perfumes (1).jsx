        ...
        <div className="max-container hero-split" style={{display:"grid", gridTemplateColumns:"1.2fr 0.8fr", alignItems:"center", width:"100%", position:"relative", zIndex:2}}>
          ...
          <div style={{padding:"8% 10%", color:"#fff"}}>
            ...
            <h2 style={{fontSize:"clamp(36px, 4.5vw, 64px)", fontWeight:700, fontFamily:"'Montserrat',sans-serif", color:"#fff", lineHeight:1.1, marginBottom:24, letterSpacing: "-1px", textTransform:"uppercase"}}>
              Trusted by 50,000+ <br/><span style={{color:"#C8A97E", fontWeight:700}}>Happy Customers</span>
            </h2>
      ...
      <div style={{padding:"80px 5%"}}>
        ...
        <div style={{display:"flex", flexDirection:"column", alignItems:"center", marginBottom:88}}>
          <div style={{textAlign:"center", maxWidth:800, marginBottom:48}}>
            <h2 className="disp" style={{fontSize:"clamp(32px, 4vw, 42px)", fontWeight:300, color:"#3c1152", lineHeight:1.2, margin:0, fontFamily:"'Montserrat', sans-serif"}}>
              Head Office &amp; Manufacturing Unit
            </h2>
