      ...
      <section style={{padding:"32px 5%"}}>
        ...
        >
          <style>{`
            ...
            @keyframes softPulse{0%,100%{opacity:.8;}50%{opacity:1;}}
            .blink-dot{animation:blinkDot 1.8s ease-in-out infinite;}
          ...
          <div style={{
            ...
            {/* ── Left: Gold 25% block ── */}
            <div style={{
              background:"linear-gradient(160deg,#C9A84C 0%,#F0D070 38%,#B8922A 65%,#8B6510 100%)",
              display:"flex",flexDirection:"column",
              alignItems:"center",justifyContent:"center",
              padding:"36px 20px",position:"relative",overflow:"hidden",
            }}>
              {/* Shimmer */}
              <div style={{position:"absolute",top:0,left:0,width:"50%",height:"100%",background:"linear-gradient(90deg,transparent,rgba(255,255,255,.22),transparent)",animation:"shimmerSweep 3s ease-in-out infinite",pointerEvents:"none"}}/>
              <p style={{fontSize:8,letterSpacing:5,color:"rgba(0,0,0,.5)",textTransform:"uppercase",fontFamily:"'DM Sans',sans-serif",marginBottom:6}}>Limited Time</p>
              <p className="disp soft-pulse" style={{fontSize:"clamp(56px,6vw,80px)",fontWeight:700,color:"#000",lineHeight:.85,letterSpacing:-3}}>25%</p>
              <p className="disp" style={{fontSize:"clamp(16px,2vw,22px)",fontWeight:300,color:"rgba(0,0,0,.65)",letterSpacing:4,marginBottom:10}}>OFF</p>
              <div style={{width:32,height:1,background:"rgba(0,0,0,.25)",marginBottom:10}}/>
              <p style={{fontSize:8,letterSpacing:3,color:"rgba(0,0,0,.5)",textTransform:"uppercase",fontFamily:"'DM Sans',sans-serif",textAlign:"center",lineHeight:1.6}}>On All<br/>Fragrances</p>
            </div>

            {/* ── Center: Main content ── */}
            <div style={{
              padding:"clamp(24px,4vw,52px) clamp(24px,4vw,48px)",
              display:"flex",flexDirection:"column",justifyContent:"center",
              borderLeft:"1px solid rgba(184,146,42,.15)",
              borderRight:"1px solid rgba(184,146,42,.15)",
            }}>
              {/* Live indicator */}
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:16}}>
                <span className="blink-dot" style={{width:6,height:6,borderRadius:"50%",background:"#B8922A",display:"inline-block",boxShadow:"0 0 6px rgba(184,146,42,.8)"}}/>
                <p style={{fontSize:9,letterSpacing:4,color:"#B8922A",textTransform:"uppercase",fontFamily:"'DM Sans',sans-serif"}}>Sale Active</p>
              </div>
              {/* Heading */}
              <h2 className="disp" style={{fontSize:"clamp(26px,3.5vw,52px)",fontWeight:300,color:"#fff",lineHeight:1,letterSpacing:-1,marginBottom:10}}>
                Khadlaj<br/>
                <em style={{fontStyle:"italic",color:"#B8922A",fontWeight:300}}>Summer Sale</em>
              </h2>
              {/* Divider */}
              <div style={{width:40,height:1,background:"linear-gradient(90deg,#B8922A,transparent)",margin:"14px 0"}}/>
              {/* Description */}
              <p style={{fontSize:13,color:"rgba(255,255,255,.45)",fontFamily:"'DM Sans',sans-serif",lineHeight:1.75,marginBottom:24,maxWidth:340}}>
                400+ fragrances — from everyday Atyaab to rare Master Perfumery extraits — all at flat 25% off.
              </p>
              {/* CTA row */}
              <div style={{display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
                <button
                  className="btn-gold"
                  style={{padding:"11px 26px",fontSize:10,letterSpacing:2.5}}
                  onClick={e=>{e.stopPropagation();setPage("collections");}}
                >Shop Sale</button>
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  <span style={{fontSize:9,color:"rgba(255,255,255,.3)",fontFamily:"'DM Sans',sans-serif",letterSpacing:1}}>CODE</span>
                  <span style={{
                    background:"rgba(184,146,42,.1)",
                    border:"1px solid rgba(184,146,42,.5)",
                    color:"#D4AF5A",padding:"6px 16px",
