...
function ProductCard({ p, onView, onCart }){
  ...
  const imageScale = {
    ...
    "Bleu Glacé": 0.62,
    "Saraya": 0.78,
    "SPECIAL EDITION SHIYAAKA SNOW": 1.05,
  ...
  const imageShiftY = {
    ...
    "Bleu Glacé": 0.02,
    "Saraya": 0.06,
    "SPECIAL EDITION SHIYAAKA SNOW": 0,
            ...
            {product.detailImages ? (
              ...
              <div
                ...
                onMouseEnter={e=>{
                  ...
                  const sc = product.name === "SPECIAL EDITION SHIYAAKA SNOW" ? 1.05 : product.name === "PANACHE ANGEL DUST" ? 1.15 : 1;
              ...
              >
                <img
                  ...
                  style={{
                    ...
                    transform: `scale(${product.name === "SPECIAL EDITION SHIYAAKA SNOW" ? 1.05 : product.name === "PANACHE ANGEL DUST" ? 1.15 : 1})`
                  }}
                />
              </div>
            )}
        ...
        <div style={{padding:"0 5%"}}>
          <div style={{display:"grid",gridTemplateColumns:"1fr auto 1fr",alignItems:"center",minHeight:80,padding:"12px 0",gap:24}}>
            ...
            <div onClick={()=>setPage("home")} style={{cursor:"pointer",textAlign:"center",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center"}}>
              <img
                src="/assets/images/khadlaj-logo.png?v=2"
