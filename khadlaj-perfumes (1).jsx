      ...
      <nav style={{
        ...
        <div style={{padding:"0 5%"}}>
          ...
          <div style={{
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:20}}>
              <span className="hide-mob" style={{
                fontSize:10,letterSpacing:2,color:"#555",textTransform:"uppercase",cursor:"pointer",
                fontFamily:"'DM Sans',sans-serif",
              }} onClick={()=>setPage("contact")}>Sign Up</span>
              <span style={{cursor:"pointer",fontSize:16,color:"#000",lineHeight:1}}>⌕</span>
          ...
          <div className="hide-mob" style={{
            ...
            paddingBottom:14,
            fontSize:10,letterSpacing:2.5,textTransform:"uppercase",color:"#000",
            fontFamily:"'DM Sans',sans-serif",
          }}>
            {[
              ["Offers","collections"],
              ...
              <span
                ...
                style={{
                  cursor:"pointer",
                  borderBottom: page===pg ? "1px solid #000" : "1px solid transparent",
                  paddingBottom:4,
