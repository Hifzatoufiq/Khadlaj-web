...
url = "https://khadlaj-perfumes.com/products.json?limit=8"
...
for idx, p in enumerate(products):
    ...
    prod_str = f'  {{ id: 200{idx}, name: "{name}", col: "Perfume Spray", price: {price}, size: "100ml EDP", badge: "{badge}", gender: "{gender}", notes: ["Bergamot", "Musk", "Oud"], img: "{img}" }},'
