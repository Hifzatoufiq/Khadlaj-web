...
names = [
    "STELLAR MUSK",
    "MIBRAAK",
    "OUD MUATTAR GHANAATI",
    "OUD MUATTAR KHAWAATER",
    "STELLAR OUD",
    "HANEEN ROSE GOLD",
    "HANEEN GOLD",
    "OUD MUATTAR OUD AL MAQAAM",
    "OUD MUATTAR OUD AL SAADA",
    "MYSTICAL INDIAN OUD PURE",
...
count = 0
for n in names:
    # Need to be careful with names that might be substrings of others, e.g. "HANEEN GOLD" vs "HANEEN ROSE GOLD"
    # But re.search will match the first one. Let's match the exact name using boundaries or just rely on the first match if it's unique enough.
    # To be safe, match exactly "name": "..."
