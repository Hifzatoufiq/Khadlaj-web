...
<body>
  ...
  {{ content_for_layout }}
  <script src="{{ 'bundle-v217-shopify.js' | asset_url }}"></script>
</body>
</html>"""
...
with open('bundle-v217.js', 'r', encoding='utf-8') as f:
    bundle_code = f.read()
...
with open(os.path.join(theme_dir, 'assets', 'bundle-v217-shopify.js'), 'w', encoding='utf-8') as f:
    f.write(bundle_code)
