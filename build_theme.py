...
<head>
  ...
  <script>
    ...
    window.__SHIYAAKA_VIDEO_URL__ = "{{ 'shiyaaka-sky-v3.mp4' | asset_url }}";
  </script>
</head>
<body>
  <div id="preloader">
...
shutil.copy('assets/videos/shiyaaka-sky-v3.mp4', os.path.join(theme_dir, 'assets', 'shiyaaka-sky-v3.mp4'))
