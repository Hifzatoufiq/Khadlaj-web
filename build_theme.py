...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;500;600;700&family=Cinzel:wght@400;500;600;700&family=Montserrat:wght@300;400;500;600;700&family=Tajawal:wght@400;500;700&display=swap" rel="stylesheet">
  {{ content_for_header }}
...
<body>
  ...
  {{ content_for_layout }}
  <script src="{{ 'bundle-v225-shopify.js' | asset_url }}"></script>
</body>
</html>"""
...
with open('bundle-v225.js', 'r', encoding='utf-8') as f:
    bundle_code = f.read()
...
with open(os.path.join(theme_dir, 'assets', 'bundle-v225-shopify.js'), 'w', encoding='utf-8') as f:
    f.write(bundle_code)
