...
<body>
  ...
  {{ content_for_layout }}
  <script src="{{ 'bundle-v227-shopify.js' | asset_url }}"></script>
</body>
</html>"""
...
with open('bundle-v227.js', 'r', encoding='utf-8') as f:
    bundle_code = f.read()
...
with open(os.path.join(theme_dir, 'assets', 'bundle-v227-shopify.js'), 'w', encoding='utf-8') as f:
    f.write(bundle_code)
